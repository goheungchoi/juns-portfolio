...
export default function CodeSandboxLogo() {
  return (
    <svg className="svg-inline--fa" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
      ...
      <polyline points="177 47.5 128 75.1 79 47.5" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
      <polyline points="176 209 176 153.9 224 126.9" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
      <polyline points="80 209 80 153.9 32 126.9" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
    </svg>
  )
}
